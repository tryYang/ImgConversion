...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(20, 290, 1341, 741))
        ...
        self.widget1.setGeometry(QtCore.QRect(40, 190, 561, 90))
        ...
        self.isShow_ssim_2 = QtWidgets.QRadioButton(self.widget_5)
        self.isShow_ssim_2.setChecked(True)
        self.isShow_ssim_2.setObjectName("isShow_ssim_2")
        self.horizontalLayout_3.addWidget(self.isShow_ssim_2)
        self.isShow_psnr_2 = QtWidgets.QRadioButton(self.widget_5)
        self.isShow_psnr_2.setChecked(False)
        self.isShow_psnr_2.setObjectName("isShow_psnr_2")
        self.horizontalLayout_3.addWidget(self.isShow_psnr_2)
        self.isShow_mse_2 = QtWidgets.QRadioButton(self.widget_5)
        self.isShow_mse_2.setChecked(False)
        self.isShow_mse_2.setObjectName("isShow_mse_2")
        self.horizontalLayout_3.addWidget(self.isShow_mse_2)
        self.btn_showlinechart_2 = QtWidgets.QPushButton(self.widget_5)
        self.btn_showlinechart_2.setObjectName("btn_showlinechart_2")
        self.horizontalLayout_3.addWidget(self.btn_showlinechart_2)
        self.verticalLayout_2.addWidget(self.widget_5)
        self.widget_4 = QtWidgets.QWidget(self.widget1)
        self.widget_4.setObjectName("widget_4")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget_4)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.isShow_ssim = QtWidgets.QRadioButton(self.widget_4)
        ...
        self.isShow_psnr = QtWidgets.QRadioButton(self.widget_4)
        self.isShow_psnr.setChecked(False)
        self.isShow_psnr.setObjectName("isShow_psnr")
        self.horizontalLayout_2.addWidget(self.isShow_psnr)
        self.isShow_mse = QtWidgets.QRadioButton(self.widget_4)
        self.isShow_mse.setChecked(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.isShow_ssim_2.setText(_translate("MainWindow", "SSIM"))
        self.isShow_psnr_2.setText(_translate("MainWindow", "PSNR"))
        self.isShow_mse_2.setText(_translate("MainWindow", "MSE"))
        self.btn_showlinechart_2.setText(_translate("MainWindow", "生成对比图"))
